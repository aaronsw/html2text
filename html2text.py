...
__version__ = "3.200.3.1"  # Temporarily adding the fourth revision number
...
unifiable = {
    ...
    'copy': '(C)', 'mdash': '--', 'nbsp': ' ', 'rarr': '->', 'larr': '<-',
    'middot': '*', 'ndash': '-', 'oelig': 'oe', 'aelig': 'ae',
    'agrave': 'a', 'aacute': 'a', 'acirc': 'a', 'atilde': 'a', 'auml': 'a',
    'aring': 'a', 'egrave': 'e', 'eacute': 'e', 'ecirc': 'e', 'euml': 'e',
...
class HTML2Text(HTMLParser.HTMLParser):
    ...
    def handle_emphasis(self, start, tag_style, parent_style):
        ...
        strikethrough = 'line-through' in tag_emphasis \
            and self.hide_strikethrough
    ...
    def handle_tag(self, tag, attrs, start):
        ...
        if tag in ["ol", "ul"]:
            ...
            if start:
                ...
                self.list.append({'name': list_style,
                                 'num': numbering_start})
            else:
                if self.list:
                    self.list.pop()
    ...
    def google_nest_count(self, style):
        ...
        if 'margin-left' in style:
            margin_left_count = int(style['margin-left'][:-2])
            nest_count = margin_left_count // self.google_list_indent
        return nest_count
...
def main():
    ...
    p.add_option("-e", "--asterisk-emphasis", action="store_true",
                 ...
                 help="use an asterisk rather than " +
                 "an underscore for emphasized text")
    ...
    p.add_option("-s", "--hide-strikethrough", action="store_true",
                 ...
                 help="hide strike-through text. " +
                 "only relevant when -g is specified as well")
